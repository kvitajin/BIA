...
class Graph:
    ...
    # Konštruktor triedy Graph nastavuje základné hodnoty premenných pre konstrukciu vizualizacie grafu
    ...
    def Show(self, figName, points = None, points_history = None, interval_anim = 1):
        ...
        self.path = None
        # Body, ktoré sa budu animovat (historia priechodov)
        self.points_to_anim = points_history

        # Vykreslenie animacie
        # => vykreslená historia priechodu je zobrazena červenou farbou
        ...
        # Vykreslenie bodov získaných z vyhladávacieho algoritmu
        # => výsledné body su vykreslene zelenou farbou
        if points != None:
            for point in points:
    ...
    # Zobrazenie grafu vrátane vykreslenia historie prichodov celej populacie
    def ShowByPopulation(self, figName, best_individual = None, population_history = None, interval_anim = 1):
        ...
        # Cesta bodov v animacii
        self.path = []
        # Populacia, ktorá sa bude animovat (historie průchodu)
        ...
        # => výsledný jedinec je vykresleny zelenou farbou
    ...
    # Vykreslenie animacie
    def anim(self, n):
        # Ak je už vykreslený predchádzajúci bod, tak ho odstraň
        if self.path != None:
            self.path.remove()
    ...
    def animByPopulation(self, n):
        # Ak su už vykreslené predchádzajúce body, tak ho odstraň
        if self.path:
        ...
        # Pokiaĺ existuju body pre vykreslenie tak ich vykresli
        if self.population_to_anim != None:
